...
3. **Agent 运行时** (`src/agents/`)
   - 集成 Pi Agent Core (@mariozechner/pi-agent-core)
   - 支持多种 AI 模型提供商
   - 工具调用和会话管理
...
**内置渠道**: Telegram, Discord, Slack, Signal, iMessage, LINE, WhatsApp
**扩展渠道**: Matrix, Microsoft Teams, Mattermost, Google Chat, BlueBubbles, Zalo, Zalo Personal, Twitch, Nostr, Urbit, 语音通话
